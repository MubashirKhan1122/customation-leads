                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                        ...
                        {result.phone && (
                          <>
                            <span><Phone className="w-3 h-3 inline" /> {result.phone}</span>
                            <a
                              href={`https://wa.me/${result.phone.replace(/[^0-9+]/g, '')}?text=${encodeURIComponent(
                                `Hi ${result.name.split(' ')[0]}, I noticed your business${result.website ? ` website (${result.website.replace(/https?:\/\//, '')})` : ''} could use some improvements. I specialize in web design and digital marketing. Would you be interested in a free consultation?`
                              )}`}
